package tests.drivers.HidatoHexagon;
...
public class DriverHidatoHexagon {
	...
	private static void driverGetTipusCella() {
		...
		System.out.println("Ara es cridara el mètode getTipusCella, s'espera que es retorni el seguent tipus d'adjacencia: " + TipusCella.HEXAGON);
		TipusCella retornat = hidato.getTipusCella();
		System.out.println("El tipus d'adjacencia retornat es: " + retornat);
		boolean correcte = (retornat == TipusCella.HEXAGON);
